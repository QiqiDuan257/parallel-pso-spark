...
object DemoPSOSpark extends App {
  ...
  //  val psoSparkAlgoParams = new PSOSparkAlgoParams(30000, 10)
  //  val optAlgo = new PSOSpark(psoSparkAlgoParams, sparkContext)
  ...
  //  val testParams = new TestParams(3, true, 20180308)
  //  val psoSparkAlgoParams = new PSOSparkAlgoParams(200000, 40)
  //  val optAlgo = new PSOSpark(psoSparkAlgoParams, sparkContext)
  //  new RunAlgo(testParams).runDV(optAlgo.optimize)(conFuncParams, ConFunc.cfSphereDV)
  //  val runTime = (System.nanoTime() - runTimeStart) / 1.0e9 // seconds
  //  println(f"Total run time: $runTime%7.2e seconds.")
  ...
  val psoSparkAlgoParams = new PSOSparkAlgoParams(500, 100)
  val optAlgo = new PSOSpark(psoSparkAlgoParams, sparkContext)
